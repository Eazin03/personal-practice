...
response = client.chat.completions.create(
    ...
    messages=[
        {"role": "system", "content": "你是一位能够简洁快速给出答案的助手"},# 设定AI的身份和行为准则(回答的风格、限制、规则等)
        {"role": "user", "content": "你有6个苹果,分给2个人,每人有多少个苹果？"},# 用户实际提出的问题或指令
         {"role": "assistant", "content": "3个"},# 设定AI的身份和行为准则(回答的风格、限制、规则等)
        {"role": "user", "content": "分给3个人呢"}# 用户实际提出的问题或指令
              ],  # 输入内容
    stream= True
)
'''
